...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="SA:FR San Andreas First Responders">
    <meta name="theme-color" content="hsl(216, 42%, 17%)">
    <meta property="og:title" content="SA:FR" />
    <meta property="og:url" content="https://www.safrrp.com/" />
    <meta property="og:image" content="assets/img/logo.png" />
    <title>San Andreas: First Responders</title>
                ...
                <div class="user-record-entries">
                    <div class="records-left">
                        <table>
                            ...
                            <tr>
                                <td><a style="color: white; text-decoration: none;" href="<?php echo $base_url; ?>/filesystem/citations.php?citationID=<?php echo $citation_result['citationID']; ?>"><i class="fa-solid fa-link"></i> <?php echo substr($citation_result['citationID'], 0, 5);?></a></td>
                    ...
                    <div class="records-center">
                        <table>
                            ...
                            <tr>
                                <td><a style="color: white; text-decoration: none;" href="<?php echo $base_url; ?>/filesystem/reports.php?caseID=<?php echo $report_result['caseID']; ?>"><i class="fa-solid fa-link"></i> <?php echo substr($report_result['caseID'], 0, 5);?></a></td>
                    ...
                    <div class="records-right">
                        <table>
                            ...
                            <?php foreach($arrest_record_result as $arrest_result): ?>
                                <tr>
                                    <td><a style="color: white; text-decoration: none;" href="<?php echo $base_url; ?>/filesystem/arrestreports.php?caseID=<?php echo $arrest_result['caseID']; ?>"><i class="fa-solid fa-link"></i> <?php echo substr($arrest_result['caseID'], 0, 5);?></a></td>
